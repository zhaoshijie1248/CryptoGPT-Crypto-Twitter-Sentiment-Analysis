...
# # sk-proj-OCXhqjJqlatrb7uXc8IGT3BlbkFJ6NkvlDsKpxQVJjyVvbCc
# # from tweety import Twitter
# # export OPENAI_API_KEY={sk-proj-OCXhqjJqlatrb7uXc8IGT3BlbkFJ6NkvlDsKpxQVJjyVvbCc}
...
#         datetime.now().date() - timedelta(days=30), periods=31, freq="D"
#         # timedelta(days=30) - timedelta(days=36), periods=7, freq="D"
#     )
